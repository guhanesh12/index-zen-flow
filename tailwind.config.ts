  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--ai) / 0.6)" },
          "50%": { boxShadow: "0 0 0 14px hsl(var(--ai) / 0)" },
        },
        "signal-pop": { "0%": { transform: "scale(0.85)", opacity: "0" }, "60%": { transform: "scale(1.04)" }, "100%": { transform: "scale(1)", opacity: "1" } },
      },
      animation: {
        ...
        "signal-pop": "signal-pop 0.4s cubic-bezier(0.34,1.56,0.64,1)",
      },
    },
  },

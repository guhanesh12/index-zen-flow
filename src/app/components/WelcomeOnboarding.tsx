...
const Joyride = lazy(() => import('react-joyride').then(m => ({ default: (m as any).Joyride || (m as any).default })));
          ...
          <Joyride
            ...
            styles={{
              ...
              tooltip: {
                ...
                boxShadow: '0 25px 60px -10px rgba(16, 185, 129, 0.45), 0 0 0 1px rgba(59, 130, 246, 0.2)',
                color: '#f8fafc',
              },
              tooltipTitle: {
                fontSize: 18,
              ...
              tooltipContent: { color: '#cbd5e1', fontSize: 14, lineHeight: 1.6, padding: '4px 0' },
              buttonNext: {
              ...
              buttonBack: { color: '#94a3b8', marginRight: 10, fontWeight: 500 },
              buttonSkip: { color: '#64748b', fontWeight: 500 },
              buttonClose: { color: '#94a3b8' },
              spotlight: { borderRadius: 12, boxShadow: '0 0 0 4px rgba(16, 185, 129, 0.4), 0 0 40px rgba(59, 130, 246, 0.5)' },
              beacon: { /* default */ },
              beaconInner: { backgroundColor: '#10b981' },
              beaconOuter: { backgroundColor: 'rgba(16, 185, 129, 0.3)', borderColor: '#10b981' },
            }}
          />
        </Suspense>
      )}

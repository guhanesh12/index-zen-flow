            ...
            if (action === "BUY_CALL" || action === "BUY_PUT") {
              ...
              if (orderResult.orderId) {
                ...
                const positionData = {
                  ...
                  quantity: symbol.quantity || symbol.lotSize || symbol.lot_size || 15,
                  lotSize: _resolveLotSize(indexName, symbol.lotSize, symbol.lot_size),
      ...
      await supabaseAdmin.from("position_monitor_state").upsert(
        {
          ...
          raw_position: {
            ...
            lotSize: _resolveLotSize(normalizedIndex, position.lotSize, symbol.lotSize, symbol.lot_size),

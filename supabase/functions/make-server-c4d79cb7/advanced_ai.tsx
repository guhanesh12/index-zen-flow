...
export class AdvancedAI {
  ...
  public static generateAdvancedSignal(
    ...
    const openingRangeHigh = openingRangeCandles.length
      ...
      : priorSessionHigh;
    const openingRangeLow = openingRangeCandles.length
    ...
    if (action === "BUY_CALL") {
      ...
      const failedBreakoutUp =
        lastCandle.high > prevCandle.high && closePosUp < 0.35;
      if (exhaustedUp || failedBreakoutUp) {
      ...
      const failedBreakdownDn =
        lastCandle.low < prevCandle.low && closePosDn < 0.35;
      if (exhaustedDn || failedBreakdownDn) {
    ...
    return {
      ...
      debugInfo: {
        ...
        trendAnchorBreakBear,
        dayBreakoutHigh: +dayBreakoutHigh.toFixed(2),
        dayBreakoutLow: +dayBreakoutLow.toFixed(2),
